      ...
      <div className="z-50 fixed left-0 top-0 w-[100vw] h-[100vh] flex items-center justify-center bg-[rgba(0,0,0,0.8)]">
        <div className="w-[810px] rounded-lg flex relative bg-bottom bg-cover bg-no-repeat"
          ...
          <div className="flex-1 flex flex-col">
            <div className="flex-1 mx-8 my-9 space-y-4">
              ...
              <div className="text-base font-medium text-black text-center hidden">
            ...
            <div className="py-6 border-t border-[rgba(0,0,0,0.32)] font-medium text-sm text-black flex justify-center items-center">
              {type === ACCOUNT.SIGN_UP &&
                <span>
